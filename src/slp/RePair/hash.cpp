...
int 
Hash::searchHash (Thash H, Tpair p) 
...
void 
Hash::deleteHash (Thash *H, int id) 
...
Thash 
Hash::createHash (int maxpos, Trarray *Rec)
...
int 
Hash::finsertHash (Thash H, Tpair p) 
...
void 
Hash::insertHash (Thash *H, int id) 
